...
import com.tuya.community.business.sdk.demo.adapter.CommonDebugDeviceAdapter;
import com.tuya.community.business.sdk.demo.bean.DpLogBean;
import com.tuya.community.business.sdk.demo.presenter.CommonDeviceDebugPresenter;
 ...
 */
public class CommonDeviceDebugActivity extends BaseActivity implements ICommonDeviceDebugView, View.OnClickListener {
    ...
    public void initView() {
        mDpListView = findViewById(R.id.lv_dp_list);
        mLogView = findViewById(R.id.test_log);
        testScroll = findViewById(R.id.test_scroll);
        mOffLineView = findViewById(R.id.v_off_line);
        mOffLineTip = findViewById(R.id.network_tip);

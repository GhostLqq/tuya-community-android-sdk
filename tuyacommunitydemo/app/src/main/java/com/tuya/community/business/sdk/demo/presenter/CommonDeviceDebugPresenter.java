...
import com.tuya.community.business.sdk.demo.bean.AlertPickBean;
import com.tuya.community.business.sdk.demo.bean.DpLogBean;
import com.tuya.community.business.sdk.demo.utils.DialogUtil;
import com.tuya.community.business.sdk.demo.utils.SchemaMapper;
import com.tuya.community.business.sdk.demo.utils.ToastUtil;
import com.tuya.community.business.sdk.demo.view.ICommonDeviceDebugView;
import com.tuya.community.business.sdk.demo.widget.AlertPickDialog;
...
public class CommonDeviceDebugPresenter extends BasePresenter implements IDevListener {
    ...
    private void initListener() {
        mTuyaDevice = TuyaCommunitySDK.getCommunityDeviceManageInstance().newDeviceInstance(mDevId);
        mTuyaDevice.registerDevListener(this);
    }

    private void initData() {
        mDevId = ((Activity) mContext).getIntent().getStringExtra(INTENT_DEVID);
        mDevBean = TuyaCommunitySDK.getCommunityDataManager().getDeviceBean(mDevId);
        if (mDevBean == null) {
...
//        }
    ...
    public void onDpUpdate(String devId, String dpStr) {
        ...
        DeviceBean deviceBean = TuyaCommunitySDK.getCommunityDataManager().getDeviceBean(devId);
    ...
    public JSONObject getDpValueWithOutROMode(String devId, String value) {
        ...
        for (Map.Entry<String, Object> entry : jsonObject.entrySet()) {
            ...
            Map<String, SchemaBean> schema = TuyaCommunitySDK.getCommunityDataManager().getSchema(devId);
            if (schema != null) {
